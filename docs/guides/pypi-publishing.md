...
The repository includes a production-ready publishing workflow at [`.github/workflows/publish.yml`](https://github.com/folioman/tickertape-client/blob/main/.github/workflows/publish.yml).
